...
pub const DICTIONARY: [&str; 1024] = [
    ...
    "fun", "future", "fuzz", "gables", "gadget", "gag", "gain", "galaxy", "gambit", "gang", "gasp",
    "gather", "gauze", "gave", "gawk", "gaze", "gecko", "geek", "gel", "germ", "geyser", "ghetto",
    "ghost", "giant", "giddy", "gift", "gills", "ginger", "girth", "give", "glass", "glide",
    "gnaw", "gnome", "goat", "goblet", "goes", "going", "gone", "gopher", "gossip", "got", "gown",
    "grunt", "guest", "guide", "gulp", "guru", "gust", "gutter", "guy", "gypsy", "gyrate", "hair",
    "having", "hawk", "haze", "heel", "heft", "height", "hence", "hero", "hide", "hijack", "hike",
    "hill", "hinder", "hip", "hire", "hive", "hoax", "hobby", "hockey", "hold", "honk", "hook",
    "hop", "horn", "hot", "hover", "howl", "huddle", "hug", "hull", "hum", "hunt", "hut", "hybrid",
    ...
    "knee", "knife", "koala", "ladder", "lagoon", "lair", "lakes", "lamb", "lap", "large", "last",
    ...
    "memoir", "men", "merge", "mesh", "met", "mews", "mice", "midst", "mighty", "mime", "mirror",
    ...
    "prune", "pry", "public", "puck", "puddle", "puffin", "pulp", "punch", "puppy", "purge",
    "push", "putty", "pylon", "python", "queen", "quick", "quote", "radar", "raft", "rage", "rake",
    "rally", "ram", "rapid", "rare", "rash", "rat", "rave", "ray", "razor", "react", "rebel",
    "recipe", "reduce", "reef", "refer", "reheat", "relic", "remedy", "repent", "rerun", "rest",
    "return", "revamp", "rewind", "rhino", "rhythm", "ribs", "rich", "ride", "rift", "rigid",
    "rim", "riot", "rip", "rise", "ritual", "river", "roar", "robot", "rodent", "rogue", "role",
    "roomy", "rope", "roster", "rotate", "rover", "royal", "ruby", "rude", "rug", "ruin", "rule",
    "rumble", "run", "rural", "sack", "safe", "saga", "sail", "sake", "salad", "sample", "sand",
    "sash", "satin", "save", "scenic", "school", "scoop", "scrub", "scuba", "second", "sedan",
    "seed", "setup", "sew", "sieve", "silk", "sip", "siren", "size", "skate", "skew", "skull",
    "slid", "slow", "slug", "smash", "smog", "snake", "sneeze", "sniff", "snout", "snug", "soap",
    "sob", "soccer", "soda", "soggy", "soil", "solve", "son", "soot", "sort", "sow", "soy",
    "space", "speed", "sphere", "spout", "sprig", "spud", "spy", "square", "stick", "subtly",
    "suede", "sugar", "sum", "sun", "surf", "sushi", "suture", "swept", "sword", "swung", "system",
    "tab", "tacit", "tag", "tail", "take", "talent", "tamper", "tan", "task", "tattoo", "taunt",
    ...
    "titan", "today", "toffee", "toilet", "token", "tonic", "topic", "torch", "toss", "total",
    "touch", "towel", "toxic", "toy", "trash", "trend", "tribal", "truth", "try", "tube", "tuck",
    "tudor", "tuft", "tug", "tulip", "tune", "turn", "tusk", "tutor", "tuxedo", "twang", "twice",
    "tycoon", "type", "tyrant", "ugly", "ulcer", "umpire", "uncle", "under", "uneven", "unfit",
    "union", "unmask", "unrest", "unsafe", "until", "unveil", "unwind", "unzip", "upbeat",
    "update", "uphill", "upkeep", "upload", "upon", "upper", "urban", "urge", "usage", "use",
    "usher", "using", "usual", "utmost", "utopia", "vague", "vain", "value", "vane", "vary", "vat",
    "vault", "vector", "veer", "vegan", "vein", "velvet", "vest", "vexed", "vial", "victim",
    "video", "viking", "violin", "viper", "vital", "vivid", "vixen", "vocal", "vogue", "voice",
    "vortex", "vote", "vowel", "voyage", "wade", "waffle", "waist", "wake", "want", "warp",
    "water", "wax", "wedge", "weird", "went", "wept", "were", "whale", "when", "whole", "width",
    "wield", "wife", "wiggle", "wild", "winter", "wire", "wise", "wives", "wizard", "wobbly",
    "woes", "woken", "wolf", "woozy", "worry", "woven", "wrap", "wrist", "wrong", "yacht", "yahoo",
    "yanks",
];
