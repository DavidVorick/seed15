...
pub const DICTIONARY: [&str; 1024] = [
    ...
    "knee", "knife", "koala", "ladder", "lagoon", "lair", "lake", "lamb", "lap", "large", "last",
    ...
    "riot", "rip", "rise", "ritual", "river", "roar", "robot", "rodent", "rogue", "role", "roomy",
    ...
    "towel", "toxic", "toy", "trash", "trend", "tribal", "truth", "try", "tube", "tuck", "tudor",
    ...
    "wiggle", "wild", "winter", "wire", "wise", "wives", "wizard", "wobbly", "woes", "woken",
    "wolf", "woozy", "worry", "woven", "wrap", "wrist", "wrong", "yacht", "yahoo", "yanks",
];
